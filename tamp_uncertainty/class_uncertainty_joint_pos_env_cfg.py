...
from omni.isaac.lab_tasks.manager_based.manipulation.lift.tampura_env_cfg import LiftEnvCfg
...
@configclass
class FrankaLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.goal = RigidObjectCfg(
            prim_path="{ENV_REGEX_NS}/Goal",
            init_state=RigidObjectCfg.InitialStateCfg(pos=[0.75, -0.15, 0.055], rot=[1, 0, 0, 0]),
            spawn=UsdFileCfg(
